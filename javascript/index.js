...
obtainInstruction("steak", 0)
  ...
  // const text = document.createTextNode("Stake is ready!");
  // listElement.appendChild(text);

  // document.querySelector("#steak").innerHTML += `<li>${step}</li>`;
  // document.querySelector( "#steak").innerHTML += `<li>${"Steak is ready!"}</li>`;
  //   //listElement = steak.appendChild(text);
  //   return obtainInstruction(listElement);
  // });
...
let array = [];
 for (let i = 0; i < brusselsSprouts.length; i++) {
  const step = array.push(brusselsSprouts[i]);
  // array = brusselsSprouts.map(string.values);
  // console.log(step)
  // console.log(array)
  console.log(array)
